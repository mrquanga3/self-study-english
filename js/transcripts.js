...
window.TRANSCRIPTS = {
  // [casual spoken form, standard written-English form]
  reductions: [
    ["I wanna go home.", "I want to go home."],
    ["Do you wanna join us?", "Do you want to join us?"],
    ["She’s gonna call later.", "She is going to call later."],
    ["It’s gonna rain.", "It is going to rain."],
    ["I gotta finish this today.", "I have got to finish this today."],
    ["You gotta see this.", "You have got to see this."],
    ["I hafta leave early.", "I have to leave early."],
    ["We hafta try again.", "We have to try again."],
    ["I’m kinda tired.", "I’m kind of tired."],
    ["That’s kinda weird.", "That’s kind of weird."],
    ["I sorta agree.", "I sort of agree."],
    ["It’s sorta broken.", "It’s sort of broken."],
    ...
    ["Dunno if it works.", "I don’t know if it works."],
    ["We’re outta time.", "We’re out of time."],
    ["He walked outta the room.", "He walked out of the room."],
    ["I shoulda called.", "I should have called."],
    ["They coulda won.", "They could have won."],
    ["He woulda helped.", "He would have helped."],
    ["I ain’t ready.", "I’m not ready."],
    ["She ain’t here.", "She isn’t here."],
    ["I gotta deploy the server.", "I have got to deploy the server."],
    ["We’re gonna refactor the code.", "We are going to refactor the code."],
    ["You gotta check the logs.", "You have got to check the logs."],
    ["I wanna merge this branch.", "I want to merge this branch."],
    ["I wanna transfer some money.", "I want to transfer some money."],
    ["I gotta pay off the loan.", "I have got to pay off the loan."],
    ["They’re gonna review my account.", "They are going to review my account."],
    ["I hafta update my PIN.", "I have to update my PIN."],
    ["I'm tired 'cuz I worked late.", "I’m tired because I worked late."],
    ["Whatcha doing?", "What are you doing?"],
    ["There's a lotta work.", "There is a lot of work."],
    ["I'm supposed to finish today.", "I am supposed to finish today."],
    ["I used to live here.", "I used to live here."],
    ["She's trying to help.", "She is trying to help."],
